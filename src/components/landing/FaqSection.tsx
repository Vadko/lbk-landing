...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Оберіть гру в лаунчері й натисніть кнопку «Видалити переклад». Лаунчер автоматично відновить оригінальні файли з резервної копії. Резервна копія створюється локально, і немає терміну зберігання.",
  },
  {

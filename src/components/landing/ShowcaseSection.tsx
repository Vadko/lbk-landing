...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Програма автоматично створює бекапи оригінальних файлів перед кожною зміною, щоб ви могли повернути початковий стан гри в будь-який момент.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Оптимізовано для комфортної гри на портативних консолях та різних операційних системах.",
  },
  {
